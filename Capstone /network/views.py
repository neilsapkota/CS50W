...
def blog(request):
    ...
    return render(request, "pokhara/blog.html", {
        "posts": page_obj,
...
def index(request):
       return render(request, "pokhara/index.html")
   
def about(request):
    return render(request, "pokhara/about.html")

def chat(request):
    return render(request, "pokhara/chat.html")

def marketplace(request):
    return render(request, "pokhara/marketplace.html")   
...
def login_view(request):
    if request.method == "POST":
        ...
        if user is not None:
            ...
            return render(request, "pokhara/login.html", {
...
def register(request):
    if request.method == "POST":
        ...
        if password != confirmation:
            return render(request, "pokhara/register.html", {
...
def new_post(request):
    if request.method == "POST":
        ...
        return render(request, "pokhara/create.html")
...
def view_user(request, user_id, page_no):
    ...
    return render(request, "pokhara/user.html", {
        "posts": posts,
        "liked_posts": liked_posts,
        "usr": usr_,
...
def view_post(request, post_id):
    ...
    return render(request, 'pokhara/post.html', {'post': post})    
